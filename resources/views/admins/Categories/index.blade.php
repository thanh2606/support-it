        ...
        <div class="">
            <div class="page-title">
                <div class="title_left">
                    <a href="{{ route('categories.index') }}"><h3>Lĩnh vực</h3></a>
                    <div class="x_content">
                        <a href="{{ route('categories.create') }}" class="btn btn-success btn-xs createResource"><i class="fa fa-plus-square"></i> Tạo mới
                        </a>
                    </div>
                </div>
            </div>
                    ...
                    <div class="x_panel">
                        <div class="x_content">
                            ...
                            <div id="session-table">
                                @include('admins.tables.category')
                            </div>
...
@section('script')
    <script src="{{ asset('admin/build/js/category.js') }}"></script>
